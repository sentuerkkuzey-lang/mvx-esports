...
export const Route = createFileRoute("/teams/rainbow-six-siege")({
  head: () => ({
    meta: [
      { title: "Rainbow Six Siege Roster — MVX Esports" },
      {
        name: "description",
        content: "Meet the MVX Esports Rainbow Six Siege roster.",
      },
      { property: "og:title", content: "Rainbow Six Siege Roster — MVX Esports" },
      {
        property: "og:description",
        content: "The players representing MVX Esports in Rainbow Six Siege.",
      },
    ],
  }),
  component: RainbowSixSiegeRosterPage,
});
...
const roster: Player[] = [
  { flagUrl: flagGb, country: "United Kingdom", name: "Alfie", rank: "Diamond 1" },
];
...
function RainbowSixSiegeRosterPage() {
  return (
    <>
          ...
          <Reveal>
            <div className="flex items-center gap-6">
              ...
              <div>
                ...
                <h1 className="mt-3 text-display-lg uppercase">Rainbow Six Siege</h1>
              </div>
            </div>
          </Reveal>
          <Reveal delay={120}>
            <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
              A tactical, disciplined division built for the demands of Rainbow Six Siege.
              Every operator plays with purpose — Pure Class under pressure.
            </p>
          </Reveal>
        </div>
      </section>
